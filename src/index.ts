...
const useUuid = <V extends Version = DefaultVersion>(
  version: V | DefaultVersion = DEFAULT_VERSION
) => {
  const generator = generators[version];
  // TODO better typing
  const generate = (args: GeneratorArgs<V>) =>
    (generator as any)(...args) as string;
